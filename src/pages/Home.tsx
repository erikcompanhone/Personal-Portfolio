      ...
      <section className="flex flex-col md:flex-row md:items-center gap-8">
        <div className="md:w-1/2">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/contact"
              className="flex-1 md:flex-none md:w-36 px-6 py-3 bg-accent text-white rounded-md flex items-center justify-center gap-2 hover:bg-opacity-90 transition-colors"
            >
              Contact Me <ArrowRightIcon size={18} />
            </Link>
            <Link
              to="/projects"
              className="flex-1 md:flex-none md:w-36 px-6 py-3 bg-transparent border border-accent text-accent rounded-md flex items-center justify-center hover:bg-accent hover:bg-opacity-10 transition-colors"
            >
              View Projects
            </Link>
          </div>
